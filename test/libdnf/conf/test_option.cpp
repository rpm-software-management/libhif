...
void OptionTest::test_options_bool() {
    ...
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, true), Option::WriteLocked);
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, false), Option::WriteLocked);
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, std::string("true")), Option::WriteLocked);
}
...
void OptionTest::test_options_child() {
    ...
    CPPUNIT_ASSERT_THROW(ochild.set(Option::Priority::RUNTIME, true), Option::WriteLocked);
    CPPUNIT_ASSERT_THROW(ochild.set(Option::Priority::RUNTIME, false), Option::WriteLocked);
    CPPUNIT_ASSERT_THROW(ochild.set(Option::Priority::RUNTIME, std::string("true")), Option::WriteLocked);
}
...
void OptionTest::test_options_enum() {
    ...
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, "aa"), Option::WriteLocked);
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, "dd"), Option::WriteLocked);
}
...
void OptionTest::test_options_number() {
    ...
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, 1), Option::WriteLocked);
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, 2), Option::WriteLocked);
}
...
void OptionTest::test_options_path() {
    ...
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, "/path2"), Option::WriteLocked);
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, "/next"), Option::WriteLocked);
}
...
void OptionTest::test_options_seconds() {
    ...
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, 12), Option::WriteLocked);
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, 10), Option::WriteLocked);
...
void OptionTest::test_options_string() {
    ...
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, "do iT"), Option::WriteLocked);
    CPPUNIT_ASSERT_THROW(option.set(Option::Priority::RUNTIME, "doXXnut"), Option::WriteLocked);
}
